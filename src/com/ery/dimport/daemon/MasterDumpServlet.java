...
import com.ery.server.monitor.StateDumpServlet;
...
public class MasterDumpServlet extends StateDumpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		out.println("Master status for " + master.serverInfo + " as of " + new Date());
	...
	private void dumpServers(DaemonMaster master, PrintWriter out) {
		Map<String, HostInfo> servers = master.getServerManager().getOnlineServers();
		for (String e : servers.keySet()) {
			out.println(servers.get(e));
		}
	}
}
