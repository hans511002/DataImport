...
public class Methods {
	...
	public static <T> Object call(Class<T> clazz, T instance, String methodName, Class[] types, Object[] args) throws Exception {
		try {
			...
			LOG.fatal(
					"Constructed invalid call. class=" + clazz.getName() + " method=" + methodName + " types=" + Classes.stringify(types),
					arge);
			throw arge;
			...
			LOG.fatal("SecurityException calling method. class=" + clazz.getName() + " method=" + methodName + " types="
