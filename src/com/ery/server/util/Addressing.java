...
public class Addressing {
	 ...
	 * @param port
	 *            Server port
	 * @return Returns a concatenation of <code>hostname</code> and <code>port</code> in following form:
	 *         <code>&lt;hostname> ':' &lt;port></code>. For example, if hostname is <code>example.org</code> and port is 1234, this method
	 *         will return <code>example.org:1234</code>
	 */
