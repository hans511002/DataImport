...
public class HeapSize {
	...
	public static int jdkBit = Integer.parseInt(System.getProperty("sun.arch.data.model"));
	public static int jdkByte = jdkBit / Byte.SIZE;

	public static void premain(String args, Instrumentation inst) {
		HashTable.inst = inst;
	}

	public static int RoundJdkByte(int a) {
		return a + (jdkByte - a % jdkByte) % 8;
	}
