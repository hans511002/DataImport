...
public class SimpleByteRange implements ByteRange {
	...
	/**
	 * Create a new {@code ByteRange} lacking a backing array and with an undefined viewport.
	 */
	...
	/**
	 * Create a new {@code ByteRange} over a new backing array of size {@code capacity}. The range's offset and length are 0 and {@code
	...
	public int compareTo(ByteRange other) {
		return Bytes.compareTo(bytes, offset, length, other.getBytes(), other.getOffset(), other.getLength());
	}
