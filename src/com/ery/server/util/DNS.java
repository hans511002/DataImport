...
public class DNS {
	...
	/**
	 * @return NetworkInterface for the given subinterface name (eg eth0:0) or null if no interface with the given name can be found
	 */
	...
	/**
	 * @param nif
	 *            network interface to get addresses for
	 * @return set containing addresses for each subinterface of nif, see below for the rationale for using an ordered set
	 */
