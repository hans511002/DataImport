...
import com.ery.server.conf.Stoppable;
 ...
 * back to sleep until its sleep time is up).
 */
public class Sleeper {
	 ...
	 * 
	 * @param startTime
	 *            Time some task started previous to now. Time to sleep will be
	 *            docked current time minus passed <code>startTime<code>.
	 */
