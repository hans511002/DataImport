...
public class Classes {
	...
	/**
	 * Equivalent of {@link Class#forName(String)} which also returns classes for primitives like <code>boolean</code>, etc.
	 * 
	 * @param className
	 *            The name of the class to retrieve. Can be either a normal class or a primitive class.
