...
public class GZIPUtils {
	...
	/**
	 * Returns an gunzipped copy of the input array. If the gzipped input has been truncated or corrupted, a best-effort attempt is made to
	 * unzip as much as possible. If no data can be extracted <code>null</code> is returned.
	 */
