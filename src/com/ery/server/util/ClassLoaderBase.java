 ...
 * It also defined method getClassLoadingLock for parallel class loading and JDK
 * 1.6 support. This method (getClassLoadingLock) is similar to the same method
 * in the base class Java ClassLoader introduced in JDK 1.7, but not in JDK 1.6.
 */
public class ClassLoaderBase extends URLClassLoader {
	...
	/**
	 * Creates a DynamicClassLoader that can load classes dynamically from jar
