 ...
 * files (src/hbase-webapps/static) "/" -> the jsp server code from
 * (src/hbase-webapps/<name>)
 */
public class InfoServer extends HttpServer {
	 ...
	 *             e
	 */
	public InfoServer(String name, String bindAddress, int port, boolean findPort, final Configuration c)
			throws IOException {
	...
	private void fixupLogsServletLocation() {
		...
		// Now do my logs.
		// Set up the context for "/logs/" if "hbase.log.dir" property is
		// defined.
		String logDir = System.getProperty("dimport.log.dir");
		if (logDir != null) {
			// This is a little presumptious but seems to work.
			Context logContext = new Context((ContextHandlerCollection) this.webServer.getHandler(), logsContextPath);
	...
	protected String getWebAppsPath(String appName) throws FileNotFoundException {
		...
		String resourceName = "webapps/" + appName;
